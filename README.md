...
Five .tsv files encoding the adjacency matrices of the five pathways analyzed in the paper. These files also contain the full names of all the nodes in each pathway.
